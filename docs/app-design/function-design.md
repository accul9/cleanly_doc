...
| オリジナル機能 |               パスキー認証                |       紛失、流出の可能性があるパスワードの代替       |   ☆☆☆☆☆    |                                                                  PWA であれば WebAuthn の実装が比較的に取り入れやすい                                                                  |
...
| オリジナル機能 |              インライン編集               | 表示、編集、保存の体感応答速度を早めるための UI 設計 |   ☆☆☆☆☆    |                                           フロント実装であれば textarea→input で対応可能、可能であれば親ー子分類（クラス？）の同時表示と編集                                           |
| オリジナル機能 | Markdown 形式のファイル取り込み・書き出し | 表示、編集、保存の体感応答速度を早めるための UI 設計 |   ☆☆☆☆☆    |                                                                                           能                                                                                           |
